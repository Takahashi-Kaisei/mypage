                ...
                {openSections.career_9 && (
                  <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1">
                    <li>自分の発表テーマ：「ロジスティック回帰の理論」</li>
                      ...
                      <li className="ml-14">発表後の質問・議論に多くの時間を割くことができ，より深い勉強会を実現した．</li>
                      <li className="ml-14">発表の日程を細かく分けることで，聴講者の負担軽減，日程調整がしやすいようにした．</li>
                      <li className="ml-12">[発表に関して, 勉強会に関して, アンケート自体に関して]のアンケートを毎回実施した．</li>
                      <li className="ml-14">発表者に聴講者の生の声を届けることで，モチベーションと発表することの価値を感じてもらうことができた．</li>
                      <li className="ml-14">より良い勉強会にするため，より参加者を集めるために，聴講者の意見を取り入れることができた．</li>
