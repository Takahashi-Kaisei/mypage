            ...
            <div className="space-y-6">
                ...
                {openSections.career_11 && (
                  <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1">
                    ...
                    <li>pythonを用いて，データ加工，分析，機械学習モデルの開発を行う．</li>
                      <li className="ml-6">大規模なデータベースからの効率的なデータの抽出と，整合性チェックの経験を得た．</li>
                      <li className="ml-6">自分の頭の中で考えたことをコードに落とし込み，思い通りにデータを加工する難しさ・経験を得た．</li>
                      <li className="ml-6">ドメイン知識を駆使し，機械学習モデルにより多くの知識を与えるようなデータ分析・特徴量設計の経験を得た．</li>
                  </ul>
                )}
              </div>
                ...
                {openSections.career_10 && (
                  <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1">
                    ...
                    <li>自分が実装したモデルに関して資料を作成し，世界に公開する．→この一連のフローをモデル一つにつき行う．</li>
                      <li className="ml-6">数式をコードで表現する経験．</li>
                      <li className="ml-12">特に，数式上では問題のない実装が，コードにしたときに，オーバーフロー・計算量が多すぎる．などの問題に見舞われることが多かった．そのような問題に対して，数式上の等価を保ち，実装では計算量を抑えるような実装に工夫をする点に醍醐味を感じた．</li>
                      <li className="ml-12">生成AIツールを直接的に用いずに，なるべく自分の力で実装をすることで，数式をコードで表現する思考力を得た．</li>
                      <li className="ml-6">sklearnを開発することによる，チーム開発の経験．</li>
                      <li className="ml-12">Githubでissueを立て，ブランチを生やして実装をし，プルリクエストを行うまでのチーム開発の一連の流れを経験した．実装したモデルの問題点については，身内のコミュニケーションツールではなく，実際にGithub上で行われるようなレビューを通して議論することで，よりリアルな開発を経験した．</li>
                      <li className="ml-12">実装では，型ヒント・ドックストリングを忘れず書き，より綺麗なコードを書く経験を得た．</li>
                      <li className="ml-6">初学者でもわかるような資料を作成し，発表する経験．</li>
                      <li className="ml-12">実装したモデルについて，完璧に理解できていなければ他人に説明することができないので，聴講者が初学者であることを想定し資料を作成することで，より深い理解ができた．</li>
                      <li className="ml-12">モデルを実装するだけであれば，最終的な式(損失関数・最適化関数)さえコードで表現できれば良いが，資料を作成することで，数式の意味や，実装の意図，気持ちを理解することができた．</li>
                  </ul>
                )}
              </div>
              ...
              <div>
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <span className="text-sm text-gray-700 dark:text-gray-300">2025年3月22日~4月14日</span>
                </div>
                <p className="text-gray-700 dark:text-gray-300">
                ...
                {openSections.career_9 && (
                  <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1">
                    <li>自分の発表テーマ：「ロジスティック回帰の理論」</li>
                      <li className="ml-6">発表者：11人12テーマ</li>
                      <li className="ml-6">聴講者：平均15人ほど(後になるにつれて増加した．)</li>
                      <li className="ml-6">形式：時間無制限でLT会と同じように発表</li>
                      <li className="ml-12">主催・参加したことによるリターンやできたこと．</li>
                      <li className="ml-18">これまでのLT会の主催・参加の経験を活かしてより多くの人が参加しやすく，なおかつ活発な議論になるように工夫をした．</li>
                      <li className="ml-24">発表日程を幅広く取り，一日に1, 2テーマの発表を行った．</li>
                      <li className="ml-30">発表後の質問・議論に多くの時間を割くことができ，より深い勉強会を実現した．</li>
                      <li className="ml-30">発表の日程を細かく分けることで，聴講者の負担軽減，日程調整がしやすいようにした．</li>
                      <li className="ml-24">[発表に関して, 勉強会に関して, アンケート自体に関して]のアンケートを毎回実施した．</li>
                      <li className="ml-30">発表者に聴講者の生の声を届けることで，モチベーションと発表することの価値を感じてもらうことができた．</li>
                      <li className="ml-30">より良い勉強会にするため，より参加者を集めるために，聴講者の意見を取り入れることができた．</li>
                      <li className="ml-18">これらの工夫による影響</li>
                      <li className="ml-24">当初，勉強会のslackチャンネルの参加者は50人ほどであったが，最終的には84人まで増加した</li>
                      <li className="ml-24">当初，聴講者は平均10人ほどであったが，宣伝や工夫の結果，平均15人ほど，最後の発表では20人ほどに増加した．</li>
                ...
                {openSections.career_8 && (
                  <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1">
                    <li>生成モデルという一つのトピックがあり，従来の手法でカバーできなかった点をカバーしていく生成モデルの歴史の流れを学ぶことができた．この流れは，自分の研究を進める上で，先行研究の課題が前提としてあって，それを解決するのが研究であるという，「自分の研究の位置付け」を理解するのに非常に役に立った．</li>
                      <li className="ml-6">そのような具体的な例→VAEにおける最尤法の学習では，データ分布で低い確率の部分が押し上げられるようにモデル分布で学習されてしまい，生成画像がぼやけてしまうという課題があった．それを解決するために，評価を密度比で行いデータ分布とモデル分布を近づける．というGANの考え方が提案された．</li>
                  </ul>
                )}
              </div>
              ...
              <div>
                ...
                {openSections.career_7 && (
                  <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1">
                    <li>研究内容</li>
                      <li className="ml-6">先行研究：野球における守備指標は，一般的に打球処理の難しさベースの評価が行われている，</li>
                      <li className="ml-6">課題：このような従来の守備指標では，精神的に負荷がかかる場面での守備と，そうでない場面での守備を同等に評価してしまうという課題が存在する．これでは，真に重要な場面での守備を軽視してしまう可能性がある．</li>
                      <li className="ml-6">目的：精神的に負荷がかかる場面での守備に対し，高く評価を行う．</li>
                      <li className="ml-6">提案手法：打球処理の難しさという従来の尺度に加え．「接戦率」というどのくらい接戦の場面であるかという尺度で重みをつけることで，精神的に負荷がかかる場面での守備を高く評価する．</li>
                      <li className="ml-6">結果：既存の指標と比較して，接戦な場面で多く守備を行った選手を高評価することができた．</li>
                      <li className="ml-6">評価：従来の指標と比較して，評価される選手がどの程度変化するのか．</li>
                    <li>反省点→改善・学び</li>
                      <li className="ml-6">評価の仕方が定量的ではなく主観に近い評価となってしまった．評価指標に対する評価という部分で詰めが甘くなってしまった．→評価指標を提案している論文から評価指標の評価を提案する論文を参考にするべきだった．</li>
                      <li className="ml-6">パラメータの決定が手動になってしまった．→従来の指標でパラメータの決定は得点期待値ベースで行われていて，それが広く使われているのでその方法を踏襲するべきであった．</li>
                  </ul>
                )}
              </div>
                ...
                {openSections.career_6 && (
                  <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1">
                    <li>自分の発表テーマ：「確率論を学ぶ意義」</li>
                      <li className="ml-6">発表者：8人</li>
                      <li className="ml-6">聴講者：平均10人</li>
                      <li className="ml-12">後輩が8人中5人と，積極的に後輩を巻き込むことができた．</li>
                      <li className="ml-12">主催・参加したことによるリターンやできたこと．</li>
                      <li className="ml-18">縦の繋がりを深める機会を提供する事ができた．</li>
                      <li className="ml-18">後輩の割合が多かったので，できるだけ初学者向けの資料を作成する事ができた．</li>
                      <li className="ml-18">後輩に質問する際に，基礎知識がない前提でもわかるように質問をする事ができた．</li>
                  </ul>
                )}
              </div>
                ...
                {openSections.career_5 && (
                  <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1">
                    <li>自分の発表テーマ：「多重共線性って結局どうすればいいの？」</li>
                      <li className="ml-6">発表者：9人</li>
                      <li className="ml-6">聴講者：平均11人</li>
                      <li className="ml-12">前回のLT会により，第三回LT会では発表者の半数が同期(当時の二年生)であった．</li>
                      <li className="ml-12">主催・参加したことによるリターンやできたこと．</li>
                      <li className="ml-18">今までのLT会の経験から，人に発表するための資料を作成する事ができた．</li>
                      <li className="ml-18">聴講者の目線に立って自分の資料を作成する事ができた．</li>
                      <li className="ml-18">質問に対し，自分の知識でのできる限りの応答をする事ができた．</li>
                  </ul>
                )}
              </div>
                ...
                {openSections.career_4 && (
                  <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1">
                    <li>自分の発表テーマ：「機械学習の精度を高めよう」</li>
                      <li className="ml-6">発表者：11人16テーマ</li>
                      <li className="ml-6">聴講者：平均10人</li>
                      <li className="ml-6">主催・参加したことによるリターンやできたこと．</li>
                      <li className="ml-12">興味分野を通して横の繋がりを深めることができた．</li>
                      <li className="ml-12">今後開催する勉強会，LT会の敷居を下げることができた．</li>
                  </ul>
                )}
              </div>
              ...
              <div>
                ...
                {openSections.career_3 && (
                  <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1">
                    <li>具体的な内容</li>
                      <li className="ml-6">タスク：クレジットカードの貸し倒れ予測モデルの構築</li>
                      <li className="ml-6">評価指標：AUC</li>
                      <li className="ml-6">期間：2日(実質24時間)</li>
                      <li className="ml-6">結果：準優勝</li>
                    <li>行ったこと</li>
                      <li className="ml-6">チームとして</li>
                        <li className="ml-12">LightGBMとCNNのバギングモデル(加重平均)を構築した．</li>
                        <li className="ml-12">public leaderboardでは低いスコアだったものの，汎化性能を高めたことにより，private leaderboardでは2位までup shakeした．</li>
                      <li className="ml-6">個人として</li>
                        <li className="ml-12">AutoML(pycaret)を用いて，モデル構築の試行錯誤を高速で行った．</li>
                        <li className="ml-12">特徴量エンジニアリングの試行錯誤を行った，</li>
                      <li className="ml-6">反省点→改善・学び</li>
                        <li className="ml-12">評価指標の理解が不十分であった．そのため，評価指標からのフィードバックウを受けた効率的な試行錯誤ができなかった．→この失敗から，実験において評価が最重要であることを体感した．</li>
                  </ul>
                )}
              </div>
